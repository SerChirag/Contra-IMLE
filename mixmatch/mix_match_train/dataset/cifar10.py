...
def get_cifar10(root, n_labeled,
    ...
    #comment above 4 lines and uncomment below line for feature extraction
    #train_labeled_dataset = CIFAR10_labeled(root,  train=True, transform=transform_train)

    print (f"#Labeled: {len(train_labeled_idxs)} #Unlabeled: {len(train_unlabeled_idxs)} #Val: {len(val_idxs)}")
    return train_labeled_dataset, train_unlabeled_dataset, val_dataset, test_dataset
    #comment above 2 lines and uncomment below line for feature extraction
